        ...
        <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                <div
                    ...
                    aria-describedby="ds-confirm-msg"
                >
                    <div id="ds-confirm-title" className="text-base font-semibold">{title}</div>
                    <div id="ds-confirm-msg" className="mt-2 text-sm text-(--muted) leading-relaxed">{message}</div>
