...
const BUTTONS: { button: DsButton; label: string }[] = [
...
function getCodeForButton(keymap: DsKeymap, button: DsButton): string | null {
...
export function DsKeymapEditor({ keymap, onSetKey, onReset }: Props) {
    const [listening, setListening] = useState<DsButton | null>(null);
